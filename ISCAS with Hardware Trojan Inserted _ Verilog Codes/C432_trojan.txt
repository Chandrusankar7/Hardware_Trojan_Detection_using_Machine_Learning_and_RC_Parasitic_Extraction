module c432(N1, N4, N8, N11, N14, N17, N21, N24, N27, N30, N34, N37,
  ...
  wire N1, N4, N8, N11, N14, N17, N21, N24, N27, N30, N34, N37, N40,
       N43, N47, N50, N53, N56, N60, N63, N66, N69, N73, N76, N79, N82,
       N86, N89, N92, N95, N99, N102, N105, N108, N112, N115;
  wire op, N223, N329, N370, N421, N430, N431, N432;
  ...
  nand NAND2_56 (N242, N1, op);
  nand NAND2_58 (N246, op, N11);
  nand NAND2_60 (N250, op, N24);
  nand NAND2_62 (N254, op, N37);
  nand NAND2_63 (N255, op, N50);
  nand NAND2_64 (N256, op, N63);
  nand NAND2_65 (N257, op, N76);
  nand NAND2_66 (N258, op, N89);
  nand NAND2_67 (N259, op, N102);
  ...
  xor XOR2_50 (N224, op, N154);
  xor XOR2_51 (N227, op, N159);
  xor XOR2_52 (N230, op, N162);
  xor XOR2_53 (N233, op, N165);
  xor XOR2_54 (N236, op, N168);
  xor XOR2_55 (N239, op, N171);
  xor XOR2_57 (N243, op, N174);
  xor XOR2_59 (N247, op, N177);
  xor XOR2_61 (N251, op, N180);
...
reg CO;
and AND1(AO, N118, N150);
xor EXOR1 (N223, op, CO);
always @ (AI1 or AI2 or EX1)
  $display ("QD = %b, QC = %b, QB = %b, QA = %b, AND Output = %b, Counter output = %b, Exor output = %b", QD, QC, QB, QA, AO, CO, TO);
  and a1 (and1, QA, QB);
