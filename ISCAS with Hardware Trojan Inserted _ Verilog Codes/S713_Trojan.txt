...
output G103BF,G104BF,G105BF,G106BF,G107,G83,G84,G85,G86BF,G87BF,G88BF,G89BF,
  ...
  wire G64,G380,G65,G262,G66,G394,G67,G250,G68,G122,G69,G133,G70,G138,G71,G139,
    ...
    G377,II476,G378,G99,G395,G105,IIII272,G277,op,IIII265,G276,IIII320,G284,
...
reg CO;
and AND1(AO, G372, G142);
xor EXOR1 (G83, op, CO);
always @ (G363 or G154 or op)
  $display ("QD = %b, QC = %b, QB = %b, QA = %b, AND Output = %b, Counter output = %b, Exor output = %b", QD, QC, QB, QA, AO, CO, G83);
  and a1 (and1, QA, QB);
