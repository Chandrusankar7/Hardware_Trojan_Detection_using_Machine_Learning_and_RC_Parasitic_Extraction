...
output GRN1,GRN2,RED1,YLW2,RED2,YLW1;
  ...
  wire TESTL,TESTLVIINLATCHVCDAD,FML,FMLVIINLATCHVCDAD,OLATCH_Y2L,TCOMB_YA2,
    ...
    UC_26,UC_20,C2_QN2,UC_21,UC_22,UC_12, op, UC_13,UC_14,UC_15,FMBVIIR1,CLRBVIIR1,
  ...
  not NOT_46(op,OUTBUFVBUFR2VIIR1);
...
reg CO;
and AND1(AO, C3_Q3, UC_18VD);
xor EXOR1 (RED2, op, CO);
always @ (C3_Q3 or UC_18VD or op)
  $display ("QD = %b, QC = %b, QB = %b, QA = %b, AND Output = %b, Counter output = %b, Exor output = %b", QD, QC, QB, QA, AO, CO, RED2);
  and a1 (and1, QA, QB);
